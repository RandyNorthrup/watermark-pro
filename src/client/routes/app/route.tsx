...
export const Route = createFileRoute('/app')({
  beforeLoad: async ({ context, location }) => {
    ...
    // blocks. Mutations that change these queries drop them first
    // (resetShellQueries), so this cache-first read fetches fresh right after one
    // rather than seeing a stale value. A background revalidation runs regardless
    // — never awaited, and paused when offline — and AppLayout redirects to
    // /login if it later finds no session.
