/**
 * Schema construction only allocates validators; PURE annotations allow the lazy
 * route splitter to discard validators belonging to unvisited forms.
...
export const emailSchema = /* @__PURE__ */ z
  .email('Enter a valid email address')
  .max(EMAIL_MAX_LENGTH)

export const passwordSchema = /* @__PURE__ */ z
  .string()
...
export const nameSchema = /* @__PURE__ */ z
  .string()
  .trim()
  .min(1, 'Enter your name')
  .max(NAME_MAX_LENGTH)

export const signUpSchema = /* @__PURE__ */ z.object({
  name: nameSchema,
  email: emailSchema,
  password: passwordSchema,
})

export const signInSchema = /* @__PURE__ */ z.object({
  email: emailSchema,
  password: /* @__PURE__ */ z.string().min(1, 'Enter your password'),
})

export const organizationNameSchema = /* @__PURE__ */ z
  .string()
  .trim()
  .min(2, 'Use at least 2 characters')
  .max(ORGANIZATION_NAME_MAX_LENGTH)

export const slugSchema = /* @__PURE__ */ z
  .string()
  .min(2, 'Use at least 2 characters')
  .max(SLUG_MAX_LENGTH)
