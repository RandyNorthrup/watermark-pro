...
catalogue, logo uploads) and M4 (single-photo editor with crop, resize,
hand placement, undo and download) are complete. Bulk processing, storage
...
```
src/client/       React SPA: routes/ (file-based), components/ (ui/ primitives, designer/, editor/),
                  editor/ (crop, resize and undo logic), lib/, styles/,
...
e2e/              Playwright specs (smoke, onboarding, library and editor journeys)
