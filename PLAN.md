...
| `scripts/lib/local-admin.ts`   | Email embedded in SQL for `wrangler d1 execute --local`                                                                                                             | `d1 execute --command` takes no parameters; the helper only ever receives addresses the scripts mint themselves and rejects anything outside `[a-z0-9.-]+@[a-z0-9.-]+`. Local development database only.                                                                                    | wrangler accepts bound parameters.                                                              |
