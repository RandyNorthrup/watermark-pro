...
| Q12 | ~~Who reviews machine translations (M18)?~~ **Answered 2026-09-06:** nobody; the agent translates, back-translates in a separate pass, compares, retries once, and cuts any language that does not pass (`docs/plans/m18-localisation.md`, "Translation quality process"). Cut languages are listed here when M18 lands.                                                                                                                                                                                                  | —                                                                                             |
